...
const SvgTimeOutlineIcon = () => (
  <Svg fill="none" viewBox="0 0 24 24">
    <Path d="M12.748 6a.75.75 0 0 0-1.5 0v6.748c0 .415.336.75.75.75h4.5a.75.75 0 0 0 0-1.5h-3.75V6Z" />
    <Path
      fillRule="evenodd"
      clipRule="evenodd"
...
export const TimeOutlineIcon = (props: IIconProps) =>
  React.createElement(
    Icon,
    {
      viewBox: '0 0 24 24',
